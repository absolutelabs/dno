...
var NotificationSource = function () {
  ...
  NotificationSource.prototype.getRecent = function getRecent() {
    ...
    return _ramda2.default.ifValThen(R.pickBy(R.where({
  ...
  NotificationSource.prototype.notifiedRecentlyOf = function notifiedRecentlyOf(body) {
    ...
    if (_ramda2.default.ifThen(_ramda2.default.isObject, R.where({ body: R.contains(body) }), this.getRecent())) return true;
    return false;
  };
  ...
  NotificationSource.prototype.add = function add(notification) {
    ...
    this.notifications = _ramda2.default.qq(ls.get('browser.notifications'), {});
